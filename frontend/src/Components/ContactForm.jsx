                    ...
                    <section>
                        <form onSubmit={onSubmit} className="text-white font-poppins bg-black rounded-lg">
                            ...
                            <input
                                ...
                                name="email"
                                placeholder="Email"
                                className="bg-black w-full mb-6 border-b-2 border-gray-500 text-white p-2 rounded"
                                required
                            />
                            <textarea
                                name="message"
                                id=""
                                placeholder="Message"
                                className="bg-black w-full h-40 mb-6 border-b-2 border-gray-500 text-white p-2 rounded"
                                required
                            ></textarea>
                            <button
                                type="submit"
